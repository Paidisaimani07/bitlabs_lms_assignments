                  ...
                  {questions.length === 0 ? (
                    <>
                      <div style={{ textAlign: 'center', marginBottom: '20px',fontFamily:'Plus Jakarta Sans' }}>
                        <p style={{color:'#000',fontWeight:'bold',fontSize:'14px'}}>This form is empty</p>
                        <p style={{color:'#7B7878',fontSize:'14px'}}>Click the button below to start adding fields</p>
                      </div>
                   ...
                   <div
                        ...
                        align="center"
                      >
                        <Link onClick={handleAddQuestion} className="add-button">
                          + Add question
                        </Link>
                      </div>
