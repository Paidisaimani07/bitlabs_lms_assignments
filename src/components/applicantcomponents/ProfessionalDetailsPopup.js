...
const ProfessionalDetailsPopup = ({ applicantDetails }) => {
  ...
  useEffect(() => {
    if (applicantDetails) {
      setQualification(applicantDetails.qualification || '');
      setSpecialization(applicantDetails.specialization || '');
      setExperience(applicantDetails.experience || '');
      setPreferredJobLocations(applicantDetails.preferredJobLocations || []);
      setSkillsRequired(applicantDetails.skillsRequired || []);
    }
  }, [applicantDetails]);
      ...
      <div className="input-container-basicdetails">
        <div className="input-wrapper1">
          <Typeahead
            ...
            onChange={(selected) => handleInputChange('qualification', selected[0])}
        ...
        <div className="input-wrapper1">
          <Typeahead
            ...
            onChange={(selected) => handleInputChange('specialization', selected[0])}
  ...
  {errors.experience && <div className="error-message">{errors.experience}</div>}
        ...
        <div className="input-wrapper1">
          <Typeahead
            ...
            onChange={(selected) =>
              handleInputChange('preferredJobLocations', selected.map((option) => option.valueOf))
            }
