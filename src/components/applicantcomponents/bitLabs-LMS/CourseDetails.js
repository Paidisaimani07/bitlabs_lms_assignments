...
const COURSE_DATA = {
  ...
  "python": [
    { topic: "Introduction to python", videos: [{ title: "What is a python?", url:  "/python for beginners/important_scorm/story.html" }] },
            ...
            <div className="course-container">
              <div className="course-layout">
                ...
                <div className="course-player" ref={playerRef}>
                  {/* Fullscreen button at top-right corner */}
                  ...
                  <iframe
                    ...
                    allowFullScreen
                  />
                  <div style={{ position: "absolute", bottom: "10px", right: "10px", display: "flex", zIndex: 10 }}>
                    <ContinueButton 
